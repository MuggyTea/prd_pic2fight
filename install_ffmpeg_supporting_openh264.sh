...
cd $temp_dir
curl -o ./libopenh264-2.2.0-linux64.6.so.bz2 -L http://ciscobinary.openh264.org/libopenh264-2.2.0-linux64.6.so.bz2
bunzip2 libopenh264-2.2.0-linux64.6.so.bz2
cp libopenh264-2.2.0-linux64.6.so /usr/local/lib/libopenh264.so.2.2.0
