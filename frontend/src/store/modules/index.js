...
const store = new Vuex.Store({
    ...
    links: [
      {
        id: 1,
        user_id: "adam",
        link_title: "onelink_title1",
        description: "this is description1",
        million: false,
        createAt: new Date(),
        link_photo: "https://picsum.photos/id/108/50/50",
      },
      {
        id: 2,
        user_id: "ben",
        link_title: "onelink_title2",
        description: "this is description2",
        million: false,
        createAt: new Date(),
        link_photo: "https://picsum.photos/id/200/50/50",
      },
      {
        id: 3,
        user_id: "chimmy",
        link_title: "onelink_title3",
        description: "this is description3",
        million: false,
        createAt: new Date(),
        link_photo: "https://picsum.photos/id/300/50/50",
      },
      {
        id: 5,
        user_id: "chimmy",
      ...
      },
      {
        id: 4,
        user_id: "leo",
        link_title: "onelink_title4",
        description: "this is description4",
        million: false,
        createAt: new Date(),
        link_photo: "https://picsum.photos/id/400/50/50",
      },
    ],
    nextId: 5,
  },
  ...
  getters: {
    ...
    byId(state) {
      return function (_id) {
        var link = state.links.find((link) => link.id === _id);
        if (link) {
          return link;
        }
